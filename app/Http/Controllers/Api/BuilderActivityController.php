...
{
    /**
     * Fire-and-forget capture endpoint used by the V3 page builder frontend.
     * Identity (user / ip / agent / timestamp) is always stamped server-side:
     * the client can never spoof who or when.
     */
    ...
    /**
     * Query endpoint — IT only. Filterable + paginated trace table feed.
     */
