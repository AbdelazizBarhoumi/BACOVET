...
const ENDPOINTS = {
  ...
  itemtrxenq: {
    label: 'ItemTrxEnq', source: 'SDT', object: 'vwItemTrxEnq', object_type: 'view',
    columns: ['IsSplit', 'SONo', 'TransactionID', 'ItemNo', 'OpNo'],
    generate: (n) => repeat(n, (i) => ({
      IsSplit: i % 3 === 1 ? 1 : 0,
  ...
  vwitemtrx: {
    label: 'vwItemTrx', source: 'SDT', object: 'vwItemTrx', object_type: 'view',
  ...
  losttype: {
    label: 'LostType', source: 'SDT', object: 'vwLostType', object_type: 'view',
  ...
  losttimetrx: {
    label: 'LostTimeTrx', source: 'SDT', object: 'vwLostTimeTrx', object_type: 'view',
  ...
  rovereffectiveness: {
    label: 'RoverEffectiveness', source: 'QCM', object: 'vwRoverEffectiveness', object_type: 'view',
  ...
  production: {
    label: 'Production', source: 'QCM', object: 'vwProduction', object_type: 'view',
  ...
  inlinevsendlinecomparison: {
    label: 'InlineVSEndlineComparison', source: 'QCM', object: 'vwInlineVSEndlineComparison', object_type: 'view',
  ...
  empdefecteff: {
    label: 'EmpDefectEff', source: 'QCM', object: 'vwEmpDefectEff', object_type: 'view',
    columns: ['LogDate', 'ShiftCode', 'ProdGroup', 'EmployeeNo'],
    generate: (n) => repeat(n, (i) => ({
  ...
  vwdefect: {
    label: 'vwDefect', source: 'QCM', object: 'vwDefect', object_type: 'view',
  ...
  reject_qte: {
    label: 'reject_qte', source: 'QCM', object: 'RejectQty', object_type: 'view',
  ...
  qcmdefecttrx: {
    label: 'qcmdefecttrx', source: 'QCM', object: 'QCMDefectTrx', object_type: 'view',
  ...
  checkpassqte: {
    label: 'checkpassqte', source: 'QCM', object: 'QCCheckPassQty', object_type: 'view',
  ...
  mp_famille: {
    label: 'mp_famille', source: 'DIVATEX', object: 'mp_famille', object_type: 'table',
  ...
  mp: {
    label: 'mp', source: 'DIVATEX', object: 'mp', object_type: 'table',
  ...
  ofabrication: {
    label: 'ofabrication', source: 'DIVATEX', object: 'ofabrication', object_type: 'table',
  ...
  mouvement: {
    label: 'mouvement', source: 'DIVATEX', object: 'mouvement', object_type: 'table',
  ...
  mpconteneur: {
    label: 'mpconteneur', source: 'DIVATEX', object: 'mp_conteneur', object_type: 'table',
  ...
  articlescolis: {
    label: 'articlescolis', source: 'DIVATEX', object: 'articlecolis', object_type: 'table',
  ...
  detailcolis: {
    label: 'detail colis', source: 'DIVATEX', object: 'detailcolis', object_type: 'table',
    columns: ['IDDetailColis', 'IDColis', 'IdTaille', 'LibTaille', 'Qtte'],
    generate: (n) => {
      const sizes = [{ id: 1, lib: 'XS' }, { id: 2, lib: 'S' }, { id: 3, lib: 'M' }, { id: 4, lib: 'L' }, { id: 5, lib: 'XL' }, { id: 6, lib: 'XXL' }];
      return repeat(n, (i) => ({
  ...
  expeditions: {
    label: 'expeditions', source: 'DIVATEX', object: 'expedition', object_type: 'table',
  ...
  vue_stock: {
    label: 'vue_stock', source: 'DIVATEX', object: 'v_stockmp', object_type: 'view',
  ...
  diva_stock: {
    label: 'diva', source: 'DIVATEX', object: 'mvtstock', object_type: 'table',
...
const QUERIES = {
  ...
  packets_rejetes: {
    prestataire: 'Prestataire Alpha',
    generate: () => {
      const motifs = ['Défaut couture', 'Erreur taille', 'Tache tissu', 'Mauvais coloris', 'Défaut broderie'];
      return repeat(10, (i) => ({
        IDColis: 2001 + i * 4,
  ...
  minutes_presence: {
    prestataire: 'Prestataire Alpha',
    generate: () => EMPLOYEES.flatMap(emp =>
      [0, 1].map(daysAgo => ({
        employe: emp,
        date: today(daysAgo),
...
const JOBS_CATALOGUE = [
  ...
  { id: 47, nom: 'nbre dof livree',              action_ref: 'nombre_d_ofs_livres_avec_date_de_transfert_coupe_coupe_jemmel' },
  ...
  { id: 54, nom: 'inspection packet annes en cours',  action_ref: 'inspections_paquet_annee_en_cours' },
  { id: 55, nom: 'rejet suite ionspection',      action_ref: 'rejets_suite_inspection_paquet_annee_en_cours' },
  { id: 56, nom: 'inspection annes en cours',    action_ref: 'inspections_paquet_annee_en_cours' },
  { id: 57, nom: 'rejet anne sen cours',         action_ref: 'rejets_suite_inspection_paquet_annee_en_cours' },
  ...
  { id: 61, nom: 'rejet jour en cours',          action_ref: 'rejets_suite_inspection_paquet_jour_en_cours' },
  { id: 62, nom: 'piece produit jour',           action_ref: 'pieces_produites_jour_en_cours' },
  { id: 63, nom: 'colis total',                  action_ref: 'colis_total_3var' },
];
