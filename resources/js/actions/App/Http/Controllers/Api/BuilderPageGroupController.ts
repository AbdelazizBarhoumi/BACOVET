...
assignPage.definition = {
    methods: ["put"],
    url: '/api/builder-page-groups/assign-page',
...
reorderPages.definition = {
    methods: ["put"],
    url: '/api/builder-page-groups/reorder-pages',
} satisfies RouteDefinition<["put"]>
...
reorderGroups.definition = {
    methods: ["put"],
    url: '/api/builder-page-groups/reorder-groups',
} satisfies RouteDefinition<["put"]>
...
update.definition = {
    methods: ["put"],
    url: '/api/builder-page-groups/{id}',
} satisfies RouteDefinition<["put"]>
...
const BuilderPageGroupController = { index, store, assignPage, reorderPages, reorderGroups, update, destroy }

export default BuilderPageGroupController