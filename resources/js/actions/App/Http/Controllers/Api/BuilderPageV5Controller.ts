...
/**
* @see \App\Http\Controllers\Api\BuilderPageV5Controller::index
 * @see app/Http/Controllers/Api/BuilderPageV5Controller.php:18
 * @route '/api/v5/builder-pages'
 */
...
/**
* @see \App\Http\Controllers\Api\BuilderPageV5Controller::show
 * @see app/Http/Controllers/Api/BuilderPageV5Controller.php:54
 * @route '/api/v5/builder-pages/{slug}'
 */
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\Api\BuilderPageV5Controller::store
 * @see app/Http/Controllers/Api/BuilderPageV5Controller.php:70
 * @route '/api/v5/builder-pages'
 */
...
/**
* @see \App\Http\Controllers\Api\BuilderPageV5Controller::update
 * @see app/Http/Controllers/Api/BuilderPageV5Controller.php:103
...
duplicate.definition = {
    methods: ["post"],
    url: '/api/v5/builder-pages/{id}/duplicate',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\Api\BuilderPageV5Controller::getPermissions
 * @see app/Http/Controllers/Api/BuilderPageV5Controller.php:318
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
export const getPermissions = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
getPermissions.definition = {
    methods: ["get","head"],
    url: '/api/v5/builder-pages/{id}/permissions',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
getPermissions.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
getPermissions.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getPermissions.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
getPermissions.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getPermissions.url(args, options),
    method: 'head',
})
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
    const getPermissionsForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
        getPermissionsForm.get = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: getPermissions.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
        getPermissionsForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
/**
* @see \App\Http\Controllers\Api\BuilderPageV5Controller::savePermissions
 * @see app/Http/Controllers/Api/BuilderPageV5Controller.php:354
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
export const savePermissions = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: savePermissions.url(args, options),
    method: 'put',
})

savePermissions.definition = {
    methods: ["put"],
    url: '/api/v5/builder-pages/{id}/permissions',
} satisfies RouteDefinition<["put"]>
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
savePermissions.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
    ...
    return savePermissions.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
savePermissions.put = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: savePermissions.url(args, options),
    method: 'put',
})
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
    const savePermissionsForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: savePermissions.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/api/v5/builder-pages/{id}/permissions'
 */
        savePermissionsForm.put = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: savePermissions.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    savePermissions.form = savePermissionsForm
const BuilderPageV5Controller = { index, show, store, update, destroy, duplicate, uploadImage, showImage, getPermissions, savePermissions }

export default BuilderPageV5Controller