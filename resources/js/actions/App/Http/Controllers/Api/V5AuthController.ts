...
/**
* @see \App\Http\Controllers\Api\V5AuthController::check
 * @see app/Http/Controllers/Api/V5AuthController.php:13
 * @route '/api/v5-auth/check'
 */
...
/**
* @see \App\Http\Controllers\Api\V5AuthController::setPassword
 * @see app/Http/Controllers/Api/V5AuthController.php:29
 * @route '/api/v5-auth/set-password'
 */
...
/**
* @see \App\Http\Controllers\Api\V5AuthController::login
 * @see app/Http/Controllers/Api/V5AuthController.php:57
 * @route '/api/v5-auth/login'
 */
...
/**
* @see \App\Http\Controllers\Api\V5AuthController::logout
 * @see app/Http/Controllers/Api/V5AuthController.php:84
 * @route '/api/v5-auth/logout'
 */
...
/**
* @see \App\Http\Controllers\Api\V5AuthController::me
 * @see app/Http/Controllers/Api/V5AuthController.php:91
 * @route '/api/v5-auth/me'
 */
 ...
 */
    ...
    me.form = meForm
const V5AuthController = { check, setPassword, login, logout, me }

export default V5AuthController