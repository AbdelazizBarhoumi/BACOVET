...
/**
* @see \App\Http\Controllers\Api\V6AuthController::check
 * @see app/Http/Controllers/Api/V6AuthController.php:13
 * @route '/api/v6-auth/check'
 */
 ...
 */
    ...
    me.form = meForm
const V6AuthController = { check, setPassword, login, logout, me }

export default V6AuthController