...
export function GaugeWidget({ c, kpiData }: { c: WidgetConfig; kpiData?: KpiDataMap }) {
  ...
  const interactive = c.kpiCode && hasData;
    ...
    <div className="relative w-full h-full flex flex-col">
      ...
      >
        <span
          ...
          style={{
            fontSize: !c.kpiCode || !hasData ? 15 : 30,
            backgroundImage: !c.kpiCode || !hasData
              ? undefined
              : `linear-gradient(135deg, ${lighten(valueColor, 0.25)}, ${valueColor})`,
            WebkitBackgroundClip: !c.kpiCode || !hasData ? undefined : "text",
            backgroundClip: !c.kpiCode || !hasData ? undefined : "text",
            color: !c.kpiCode || !hasData ? "#94a3b8" : "transparent",
          }}
        >
          {displayValue}
        </span>
      ...
      {c.kpiCode && hasData && c.target != null && (
