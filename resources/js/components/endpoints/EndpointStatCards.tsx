...
export function EndpointStatCards({
    stats,
}: {
    stats: EndpointsStats | null;
}) {
    const s = stats ?? { total: 0, by_method: {}, by_source: {}, by_status: {} };
    ...
    return (
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <Panel title="Total">
                <div className="text-2xl font-bold font-mono">{s.total}</div>
            </Panel>
            <Panel title="GET">
