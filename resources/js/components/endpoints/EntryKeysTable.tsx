            ...
            <table className="w-full text-sm">
                <thead className="sticky top-0 bg-background">
                    <tr className="border-b border-border font-mono text-[10px] tracking-wider text-muted-foreground uppercase">
                        ...
                        <th className="py-2 px-3 text-left">Primary key</th>
                        <th className="py-2 px-3 text-left">Candidate keys</th>
                ...
                <tbody className="font-mono">
                    {entries.map((entry) => (
                        ...
                        >
                            <td className="max-w-[280px] truncate py-1.5 px-3 text-xs font-semibold break-all" title={entry.name}>
                                {entry.name}
                            </td>
                                ...
                                {entry.primary_key ? (
                                    <span className="inline-flex items-center gap-1.5">
                                        ...
                                        <span className="text-[10px] text-muted-foreground">
                                            {Math.round(entry.primary_key.confidence * 100)}%
                                        </span>
                                    </span>
                                ) : (
