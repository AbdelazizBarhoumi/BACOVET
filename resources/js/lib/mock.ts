...
export const logistics = {
    ...
    couverture: {
        ...
        coupe: [
            { name: 'ART-880', jours: 9 },
            { name: 'ART-721', jours: 6 },
            { name: 'ART-540', jours: 11 },
        ],
        seri: [
            { name: 'ART-880', jours: 7 },
            { name: 'ART-721', jours: 4 },
            { name: 'ART-540', jours: 10 },
        ],
    },
    stock: [
        {
            code: 'MP-1042',
            des: 'Tissu coton 220g',
            famille: 'Tissu',
            couleur: 'Noir',
            qte: 4200,
            res: 1200,
    ...
    logs: [
        {
            t: '10:42:11',
            lvl: 'INFO',
            msg: 'Synchronisation API Production réussie – 245 enregistrements',
        },
        {
            t: '10:41:02',
            lvl: 'WARN',
            msg: 'Latence détectée sur API Logistique – 850ms',
        },
        {
            t: '10:39:45',
            lvl: 'SYSTEM',
            msg: 'Sauvegarde automatique base de données terminée',
        },
        {
            t: '10:35:20',
            lvl: 'USER',
            msg: 'Connexion utilisateur s.karoui@bacovet.com',
        },
        {
            t: '10:30:00',
            lvl: 'INFO',
            msg: 'Job q/efficience_chaine exécuté (200 OK)',
        },
        {
            t: '10:25:14',
            lvl: 'ERROR',
            msg: 'Échec temporaire q/lost_time – retry réussi',
        },
    ],
    screens: [
