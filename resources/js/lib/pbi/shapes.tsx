...
export const SHAPES: Record<ShapeKind, ShapeDef> = {
    ...
    roundedRectangle: { kind: 'roundedRectangle', label: 'Rounded rectangle', defaultW: 200, defaultH: 140 },
    oval: { kind: 'oval', label: 'Oval', defaultW: 200, defaultH: 140 },
    line: { kind: 'line', label: 'Line', defaultW: 220, defaultH: 16 },
    triangle: { kind: 'triangle', label: 'Triangle', defaultW: 200, defaultH: 140 },
    rightTriangle: { kind: 'rightTriangle', label: 'Right triangle', defaultW: 200, defaultH: 140 },
    parallelogram: { kind: 'parallelogram', label: 'Parallelogram', defaultW: 200, defaultH: 140 },
    trapezoid: { kind: 'trapezoid', label: 'Trapezoid', defaultW: 200, defaultH: 140 },
    pentagon: { kind: 'pentagon', label: 'Pentagon', defaultW: 200, defaultH: 150 },
    hexagon: { kind: 'hexagon', label: 'Hexagon', defaultW: 200, defaultH: 160 },
    chevron: { kind: 'chevron', label: 'Chevron', defaultW: 200, defaultH: 140 },
    diamond: { kind: 'diamond', label: 'Diamond', defaultW: 160, defaultH: 160 },
    arrowRight: { kind: 'arrowRight', label: 'Right arrow', defaultW: 200, defaultH: 120 },
    arrowLeft: { kind: 'arrowLeft', label: 'Left arrow', defaultW: 200, defaultH: 120 },
    arrowUp: { kind: 'arrowUp', label: 'Up arrow', defaultW: 160, defaultH: 140 },
    arrowDown: { kind: 'arrowDown', label: 'Down arrow', defaultW: 160, defaultH: 140 },
};
