...
export default function TracePage() {
    ...
    useEffect(() => {
        fetch('/api/activity/users', { credentials: 'include' })
            .then((r) => (r.ok ? r.json() : []))
    ...
    return (
        <>
            <Head title="Traçabilité — BACOVET" />
            <AppShell
                page="/trace"
                title="Traçabilité"
                subtitle="Qui a touché quoi, sur quelle page, quel widget/KPI, quand et depuis où."
            >
