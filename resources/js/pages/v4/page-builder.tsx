...
import { Plus, Copy, Trash2, Pencil, ExternalLink, Link as LinkIcon, FileText, Loader2, LogOut } from "lucide-react";
...
import { useSidebarStructureV4 } from "@/lib/groups-registry-v4";
import { usePagesRegistryV4 } from "@/lib/pages-registry-v4";
...
export default function V4PageBuilder() {
  const { pages, loading, createPage, renamePage, changeSlug, duplicatePage, deletePage, updatePage } = usePagesRegistryV4();
  const { groups } = useSidebarStructureV4();
  ...
  const copyUrl = (slug: string) => {
    const url = `${window.location.origin}/v4/p/${slug}`;
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Head title="Pages Builder V4 — BACOVET" />
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-black uppercase tracking-tight">Pages Builder V4</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button onClick={doLogout} variant="outline" className="uppercase tracking-wider text-xs">
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    <div className="text-[11px] font-mono text-muted-foreground truncate flex items-center gap-1">
                      <LinkIcon className="h-3 w-3" /> /v4/p/{p.slug}
                    </div>
                  </div>
                </div>
          ...
          {editing && (
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="text-[10px] text-muted-foreground mt-1 font-mono">/v4/p/{editing.slug}</div>
              </div>
              <div>
                <div className="text-[10px] uppercase tracking-widest text-muted-foreground mb-1">Groupe</div>
                <Select
