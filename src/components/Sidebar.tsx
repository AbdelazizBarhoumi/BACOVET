...
import { useAuth, ROLE_LABEL, type RolePage } from "@/hooks/use-auth";
...
const NAV_ITEMS: {
  ...
  { to: "/development", label: "DÉVELOPPEMENT & AMÉLIORATION", code: "350", icon: Activity },
  { to: "/methods", label: "MÉTHODES", code: "", icon: LayoutDashboard },
];
...
const Sidebar = () => {
  ...
  const visibleNav = NAV_ITEMS.filter((n) => hasAccess(n.to));
