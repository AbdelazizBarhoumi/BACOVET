...
function DevPage() {
  ...
  return (
    <AppShell
      ...
      subtitle="Série 350 · KPIs mensuels prototype"
    ...
    >
      <div className="rounded-lg border border-warning/40 bg-warning/10 px-4 py-3 mb-4 text-xs font-mono">
        ...
        <span className="text-foreground/90">
          KPIs Série 350 alimentés via Google Sheets (Drive). Connecteur Google Sheets à activer
          côté Lovable Cloud pour synchronisation automatique.
        </span>
      </div>
              ...
              {[
                ...
                <tr key={i} className="border-b border-border/50">
                  ...
                  <td className="text-right">
                    <TrafficBadge status={r[3] as "green" | "orange" | "red"} />
                  </td>
                </tr>
              ))}
            </tbody>
