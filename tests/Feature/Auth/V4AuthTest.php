...
class V4AuthTest extends TestCase
{
    ...
    public function test_check_returns_has_password_for_existing_email(): void
    {
        ...
        $response = $this->postJson('/api/v4-auth/check', ['email' => $user->email]);
    ...
    {
        $response = $this->postJson('/api/v4-auth/check', ['email' => 'nobody@test.com']);
    ...
    public function test_login_succeeds_with_valid_credentials(): void
    {
        ...
        $this->assertAuthenticatedAs($user, 'v4_users');
    }
    ...
    public function test_set_password_logs_in_user(): void
    {
        ...
        $response = $this->postJson('/api/v4-auth/set-password', [
            'email' => $user->email,
            'password' => 'secret',
        ]);
    ...
    public function test_me_returns_authenticated_user(): void
    {
        ...
        $this->actingAs($user, 'v4_users');

        $response = $this->getJson('/api/v4-auth/me');
    ...
    public function test_logout_clears_session(): void
    {
        ...
        $this->postJson('/api/v4-auth/logout')->assertStatus(200);
        $this->getJson('/api/v4-auth/me')->assertStatus(401);
    }
}
